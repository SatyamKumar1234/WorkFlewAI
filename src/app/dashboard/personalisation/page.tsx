      ...
      <Card>
         ...
         <CardContent className="space-y-4">
            ...
            <div>
              ...
              >
                <span className="font-mono text-3xl sm:text-4xl font-bold tracking-tighter" style={{ color: timerColor }}>
                  12:34
                </span>
              </div>
            </div>
         </CardContent>
          <CardFooter className="border-t px-6 py-4 flex flex-col sm:flex-row items-start sm:items-center gap-2 justify-between">
